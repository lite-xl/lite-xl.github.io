...
|`alt`+`entrée`|`core:toggle-fullscreen`|
...
|`ctrl`+`suppr`|`doc:delete-to-next-word-end`|
|`ctrl`+`bas`|`doc:move-lines-down`|
|`ctrl`+`fin`|`doc:move-to-end-of-doc`|
...
|`ctrl`+`gauche`|`doc:move-to-previous-word-start`|
|`ctrl`+`n`|`core:new-doc`|
...
|`ctrl`+`entrée`|`doc:newline-below`|
|`ctrl`+`droite`|`doc:move-to-next-word-end`|
|`ctrl`+`s`|`doc:save`|
...
|`ctrl`+`shift`+`suppr`|`doc:delete-to-next-word-end`|
|`ctrl`+`shift`+`bas`|`doc:create-cursor-next-line`|
|`ctrl`+`shift`+`fin`|`doc:select-to-end-of-doc`|
...
|`ctrl`+`shift`+`gauche`|`doc:select-to-previous-word-start`|
|`ctrl`+`shift`+`o`|`core:open-project-folder`|
|`ctrl`+`shift`+`p`|`core:find-command`|
|`ctrl`+`shift`+`entrée`|`doc:newline-above`|
|`ctrl`+`shift`+`droite`|`doc:select-to-next-word-end`|
|`ctrl`+`shift`+`s`|`doc:save-as`|
|`ctrl`+`shift`+`tab`|`root:switch-to-previous-tab`|
|`ctrl`+`shift`+`haut`|`doc:create-cursor-previous-line`|
|`ctrl`+`tab`|`root:switch-to-next-tab`|
|`ctrl`+`haut`|`doc:move-lines-up`|
|`ctrl`+`v`|`doc:paste`|
|`ctrl`+`w`|`root:close`|
|`ctrl`+`x`|`doc:cut`|
|`ctrl`+`y`|`doc:redo`|
