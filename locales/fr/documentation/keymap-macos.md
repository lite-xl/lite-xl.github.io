...
fonctionnalité, ils sont juste reliés de manière légèrement différente
...
d'exploitation. MacOS, et [les autres](/fr/documentation/keymap).

## Raccourcis clavier

|Combinaison de touches|Actions|
|---------------|-------|
...
|`cmd`+`ctrl`+`entrée`|`core:toggle-fullscreen`|
...
|`cmd`+`suppr`|`doc:delete-to-end-of-line`|
|`cmd`+`bas`|`doc:move-to-end-of-doc`|
|`cmd`+`f3`|`find-replace:select-next`|
|`cmd`+`f`|`find-replace:find`|
|`cmd`+`g`|`doc:go-to-line`|
|`cmd`+`j`|`doc:join-lines`|
|`cmd`+`l`|`doc:select-lines`|
|`cmd`+`gauche`|`doc:move-to-start-of-indentation`|
|`cmd`+`n`|`core:new-doc`|
|`cmd`+`o`|`core:open-file`|
|`cmd`+`option`+`bas`|`doc:create-cursor-next-line`|
|`cmd`+`option`+`haut`|`doc:create-cursor-previous-line`|
|`cmd`+`p`|`core:find-file`|
|`cmd`+`pagedown`|`root:move-tab-right`|
|`cmd`+`pageup`|`root:move-tab-left`|
|`cmd`+`r`|`find-replace:replace`|
|`cmd`+`entrée`|`doc:newline-below`|
|`cmd`+`droite`|`doc:move-to-end-of-line`|
|`cmd`+`s`|`doc:save`|
...
|`cmd`+`shift`+`suppr`|`doc:delete-to-next-word-end`|
|`cmd`+`shift`+`bas`|`doc:select-to-end-of-doc`|
|`cmd`+`shift`+`k`|`doc:delete-lines`|
|`cmd`+`shift`+`l`|` doc:select-word `|
|`cmd`+`shift`+`l`|`find-replace:select-add-all`|
|`cmd`+`shift`+`gauche`|`doc:select-to-start-of-indentation`|
|`cmd`+`shift`+`o`|`core:open-project-folder`|
|`cmd`+`shift`+`p`|`core:find-command`|
|`cmd`+`shift`+`entrée`|`doc:newline-above`|
|`cmd`+`shift`+`droite`|`doc:select-to-end-of-line`|
|`cmd`+`shift`+`s`|`doc:save-as`|
|`cmd`+`shift`+`haut`|`doc:select-to-start-of-doc`|
|`cmd`+`haut`|`doc:move-to-start-of-doc`|
|`cmd`+`v`|`doc:paste`|
...
|`option`+`suppr`|`doc:delete-to-next-word-end`|
|`option`+`bas`|`doc:move-lines-down`|
|`option`+`gauche`|`doc:move-to-previous-word-start`|
|`option`+`droite`|`doc:move-to-next-word-end`|
|`option`+`shift`+`gauche`|`doc:select-to-previous-word-start`|
|`option`+`shift`+`droite`|`doc:select-to-next-word-end`|
|`option`+`haut`|`doc:move-lines-up`|
